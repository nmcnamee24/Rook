...
public struct PawnPlan: Codable, Equatable, Sendable {
    ...
    static func instanceLabel(role: String, id: String?) -> String {
        guard let id,
              ...
              let number = Int(suffix) else { return role }
        return "\(role) \(number)"
    }
}
...
public struct PawnReport: Codable, Equatable, Sendable {
    ...
    public init(pawn: String, task: String, status: String, id: String? = nil) {
        self.pawn = pawn
        self.task = task
        self.status = status
        self.id = id
...
public struct RookCanvasBlock: Codable, Equatable, Identifiable, Sendable {
    ...
    public static let outputSchema = #"""
    {
      ...
      "properties": {
        ...
        "kind": { "type": "string", "enum": ["weather", "calendar", "image", "code", "diagram", "list", "computer"] },
        ...
        "items": {
          ...
          "items": {
            ...
            "properties": {
              ...
              "symbol": {
                "type": "string",
                "enum": ["sun", "partly_cloudy", "cloudy", "rain", "storm", "snow", "wind", "fog", "calendar", "clock", "code", "image", "diagram", "computer", "info", "warning"]
              },
