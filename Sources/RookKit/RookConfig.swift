...
public struct RookConfig: Codable, Equatable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        followUpWindowSeconds = try container.decodeIfPresent(Double.self, forKey: .followUpWindowSeconds) ?? defaults.followUpWindowSeconds
        ...
        neuralVoiceSpeed = try container.decodeIfPresent(Double.self, forKey: .neuralVoiceSpeed) ?? defaults.neuralVoiceSpeed
        ...
        frontReasoningEffort = try container.decodeIfPresent(String.self, forKey: .frontReasoningEffort) ?? defaults.frontReasoningEffort
        reasoningEffort = try container.decodeIfPresent(String.self, forKey: .reasoningEffort) ?? defaults.reasoningEffort
        checkpointIntervalMinutes = try container.decodeIfPresent(Int.self, forKey: .checkpointIntervalMinutes) ?? defaults.checkpointIntervalMinutes
